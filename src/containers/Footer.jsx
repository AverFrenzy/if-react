          ...
          <div className="footer__links">
            <div className="footer__list">
              <ul>
                ...
                <li className="footer__list-link"><a href="#">How Triphouse works</a></li>
            ...
            <div className="footer__list">
              <ul>
                ...
                <li className="footer__list-link"><a href="">Guest houses</a></li>
                ...
                <li className="footer__list-link"><a href="">Holiday homes</a></li>
            ...
            <div className="footer__list">
              <ul>
                ...
                <li className="footer__list-link"><a href="">Contact Customer Service</a></li>
