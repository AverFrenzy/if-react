...
const HeaderAccountSVG = ({isLogoutVisible}) => {
  return (
    <svg
      className={isLogoutVisible ? ' header__account-img header__img-active' : 'header__account-img header__img'}
...
export default HeaderAccountSVG;
