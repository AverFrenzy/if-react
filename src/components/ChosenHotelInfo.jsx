...
import {setHotelInfoActionCreator} from '../actionCreators';


const ChosenHotelInfo = ({hotelInfo, setHotelInfo}) => {
    ...
    <div className='App'>
      <div className='chosen-hotel-container'>
        <div className='container'>
          ...
          <h3
            className='chosen-hotel-city'>{hotelInfo.city}, {hotelInfo.country}</h3>
...
const mapDispatchToProps = (dispatch) => ({
    setHotelInfo: (hotel) => dispatch(setHotelInfoActionCreator(hotel)),
  }
);

export default connect(mapStateToProps, mapDispatchToProps)(ChosenHotelInfo);